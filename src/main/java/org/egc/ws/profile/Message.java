...
public class Message {
    ...
    public double getValueAsDouble(String parameter) {
        return Double.parseDouble(getValueAsString(parameter));
    }

    public int getValueAsInt(String parameter) {
        return Integer.parseInt(getValueAsString(parameter));
    }

    public float getValueAsFloat(String parameter) {
        return Float.parseFloat(getValueAsString(parameter));
    }
